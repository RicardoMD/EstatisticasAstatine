...
echo "<h2> Estatísticas - Astatine Chernobyl</h2>";
include "inc/tabelas.php";
 ...
 $tabela15=new tabela();
echo "<table><tr>";
$tabela1->gerarTabela("Mais Ricos","Nome","Astatos","SELECT username,balance FROM iConomy ORDER BY balance DESC LIMIT 10");
...
$tabela3->gerarTabela("Domador","Nome","Astatos","SELECT mcmmo_users.user,mcmmo_skills.taming FROM mcmmo_users INNER JOIN mcmmo_skills ON mcmmo_users.id = mcmmo_skills.user_id ORDER by mcmmo_skills.taming DESC LIMIT 10");
